/* 
 ...
 This class created the grip object, which loads and draws its image, and checks if the image is being clicked by the user
...
public class Fruits {
	...
	public Fruits(PVector pos ) {
		//load the image of the grip
		img = ImageLoader.loadImage("assets/apples.png");
